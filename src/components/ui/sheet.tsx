		...
		<SheetPortal>
			...
			<SheetViewport inset={inset} side={side}>
				<SheetPrimitive.Popup
					className={cn(
						"bg-popover text-popover-foreground relative flex max-h-full min-h-0 w-full min-w-0 flex-col bg-clip-padding shadow-lg transition-[opacity,translate] duration-200 ease-in-out will-change-transform before:pointer-events-none before:absolute before:inset-0 before:shadow-[0_1px_--theme(--color-black/4%)] data-ending-style:opacity-0 data-starting-style:opacity-0 max-sm:before:hidden sm:before:rounded-[calc(var(--radius-2xl)-1px)] dark:bg-clip-border dark:before:shadow-[0_-1px_--theme(--color-white/8%)]",
						side === "bottom" &&
