		...
		<PreviewCardPrimitive.Portal>
			...
			>
				<PreviewCardPrimitive.Popup
					className={cn(
						"bg-popover text-popover-foreground relative flex w-64 origin-(--transform-origin) rounded-lg border bg-clip-padding p-4 text-sm text-balance shadow-lg transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] data-ending-style:scale-98 data-ending-style:opacity-0 data-starting-style:scale-98 data-starting-style:opacity-0 dark:bg-clip-border dark:before:shadow-[0_-1px_--theme(--color-white/8%)]",
						className,
					)}
